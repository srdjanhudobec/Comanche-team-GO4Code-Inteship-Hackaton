...
using ComancheSocialNetwork.Repositorys.Repositorys;
using ComancheSocialNetwork.Services.Interfaces;
using ComancheSocialNetwork.Services.Services;
...
builder.Services.AddDbContext<DatabaseContext>(options => {
    options.UseSqlServer("server=HUDOBEC;Database=ComancheSocialNetworkDb;Trusted_Connection=true;TrustServerCertificate=true");//ovde se nije koristion connection string iz appsettingsa
});
...
builder.Services.AddScoped<IAttachmentModelService, AttachmentModelService>();
